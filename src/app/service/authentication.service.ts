...
export class AuthService {
  ...
  signIn(user: User) {
    ...
    //   });
    localStorage.setItem('access_token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjA3NjMxMTMwLCJleHAiOjE2MTAyMjMxMzB9.szeQwJLhOXpPDVeFIWeqERIjZ8-ONrKemjlZKJJwoIk');
